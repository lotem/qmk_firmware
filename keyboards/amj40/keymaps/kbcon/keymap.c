...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT( \
        ...
        _______, KC_UNDS, KC_PLUS, KC_COLN, KC_DQT,  KC_NO,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
        _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, S(KC_NUHS),S(KC_NUBS),BL_TOGG, BL_INC, BL_DEC, \
        _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT \
        ),

    [_RAISE] = LAYOUT( \
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
        _______, KC_MINS, KC_EQL,  KC_SCLN, KC_QUOT, KC_NO,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
        _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NUHS, KC_NUBS, _______, _______, KC_DEL, \
    ...
    [_ADJUST] = LAYOUT( \
        ...
        _______, KC_F11,  KC_F12,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, _______, _______,  _______,  \
